...
?>
    ...
    <div class="new-comment">
        <div class="new-img-comment">
            <img src="/assets/img/avatar_<?= $avatarCounter ?>.jpg" alt="Avatar" class="new-ava-comment">
        </div>
        <div class="new-comment-content">

            <span class="new-comment-name">
                <?= $comment['author'] ?>
            </span>
