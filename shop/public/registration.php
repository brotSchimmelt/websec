...
<body class="text-center">
    <form class="form-signin" action="action_handler.php" method="post">
        ...
        <input type="text_register" name="username" id="inputName" class="form-control" aria-describedby="usernameHelp" placeholder="Username" required autofocus>
        ...
        <input type="email_register" name="mail" id="inputMail" class="form-control" aria-describedby="mailHelp" placeholder="WWU Mail" required>
        <small id="mailHelp" class="form-text text-muted">Please use your <em>@uni-muenster.de</em> mail address.</small>

        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password_register" name="password" id="inputPassword" class="form-control" placeholder="Password" required>
        ...
        <input type="password_register" name="confirmPassword" id="confirmPassword" class="form-control" placeholder="Confirm Password" required>
